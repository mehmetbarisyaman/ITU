...
Int16 aic3204_loop_stereo_in1( )
{
    ...
    Int16 j, i = 0;
    Int16 sample, data1, data2, data3, data4, dataT, dataT2;
        ...
        for ( j = 0 ; j < 1000 ; j++ )
        {
            for ( sample = 0 ; sample < 48 ; sample++ )
            {
				...
				/* Write Digital audio */
      	        ...
      	        //data3 = abs(data3);
      	        //data4 = abs(data4);
				//data3 = data3*0.2; //0.5, 0.2 ,  0.1A+0.2V
				//data4 = data4*0.2; //0.5, 0.2 ,  0.1A+0.2V
				
      	        dataT=-1*(data3);
      	        dataT2=-1*(data4);
				I2S0_W0_MSW_W = dataT;  // 16 bit left channel transmit audio data
      	        I2S0_W0_LSW_W = 0;
      	        I2S0_W1_MSW_W = dataT2;  // 16 bit right channel transmit audio data
      	        I2S0_W1_LSW_W = 0;
            }
