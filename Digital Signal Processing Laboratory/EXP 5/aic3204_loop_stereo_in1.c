...
Int16 aic3204_loop_stereo_in1( )
{
    ...
    Int16 input_16, output_16;
    float input, output;
    float x[] = {0,0,0};
    float coef[] = {0.39771648613084831, 0.39771648613084831};
   float pow16 = pow(2,16);
    /* Configure AIC3204 */
        ...
        for ( j = 0 ; j < 1000 ; j++ )
        {
            for ( ;;)
            {
				...
				/* Write Digital audio */
      	        ...
      	        input = (input_16/pow16);
      	        x[1]= x[0];
      	        x[0] = input;
      	        output = x[0] *coef[0] + x[1] *coef[1];
      	        output_16 = output*pow16;
				I2S0_W0_MSW_W = output_16;  // 16 bit left channel transmit audio data
      	        I2S0_W0_LSW_W = 0;
      	        I2S0_W1_MSW_W = output_16;  // 16 bit right channel transmit audio data
      	        I2S0_W1_LSW_W = 0;
            }
        }
    }
